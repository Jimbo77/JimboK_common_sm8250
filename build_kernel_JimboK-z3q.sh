...
mv $(pwd)/out/Image $(pwd)/out/Image-JimboK_z3q
mv $(pwd)/out/dtb.img $(pwd)/out/dtb-JimboK_z3q.img

cp $(pwd)/out/Image-JimboK_z3q ~/build/mkbootimg-master2
cp $(pwd)/out/dtb-JimboK_z3q.img ~/build/mkbootimg-master2

~/build/mkbootimg-master2/make_boot_z3q.sh 1.2.0-z3q
